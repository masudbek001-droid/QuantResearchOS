...
| **Module Status** | 58 `.mqh` + 1 `.mq5` (EA build unit: +5 advisory) + 7 scripts + 5 advisory tests + AgentOS v1.0 (8-file bus, 10 workers 1:1, CLI+validate+tests), compile pending MT5 (Linux sandbox); trading/Advisory frozen; AgentOS Git-only |
